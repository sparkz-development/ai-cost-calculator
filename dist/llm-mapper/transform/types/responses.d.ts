...
export type ResponsesInputItem = ResponsesMessageInputItem | ResponsesFunctionCallInputItem | ResponsesFunctionCallOutputInputItem | ResponsesReasoningItem;
...
export type ResponsesToolChoice = "none" | "auto" | "required" | {
    type: "function";
    function: {
        name: string;
    };
...
export type ResponsesOutputContentPart = ResponsesOutputTextPart | ResponsesOutputToolCallPart | ResponsesOutputImagePart;
...
export interface ResponsesResponseBody {
    ...
    output: (ResponsesMessageOutputItem | ResponsesFunctionCallOutputItem | ResponsesReasoningItem)[];
    parallel_tool_calls?: boolean;
...
export interface ResponseOutputItemAddedEvent extends BaseStreamEvent {
    ...
    item: (ResponsesMessageOutputItem & {
        status: "in_progress" | "completed";
    }) | ResponsesFunctionCallOutputItem | ResponsesReasoningItem;
}
...
export interface ResponseOutputItemDoneEvent extends BaseStreamEvent {
    ...
    }) | ResponsesFunctionCallOutputItem | ResponsesReasoningOutputItem;
}
...
export type ResponsesStreamEvent = ResponseCreatedEvent | ResponseInProgressEvent | ResponseOutputItemAddedEvent | ResponseContentPartAddedEvent | ResponseContentPartDoneEvent | ResponseOutputTextDeltaEvent | ResponseOutputTextDoneEvent | ResponseOutputItemDoneEvent | ResponseCompletedEvent | ResponseErrorEvent | ResponseFunctionCallArgumentsDeltaEvent | ResponseFunctionCallArgumentsDoneEvent | ResponseReasoningSummaryPartAddedEvent | ResponseReasoningSummaryTextDeltaEvent | ResponseReasoningSummaryTextDoneEvent | ResponseReasoningSummaryPartDoneEvent;
