import { AnthropicStopReason, AnthropicUsage, AnthropicContentBlock, AnthropicTool, AnthropicWebSearchTool, AnthropicToolChoice, BaseStreamEvent, WebSearchCitation } from "./common";
...
export type AnthropicContextEdit = AnthropicClearToolUsesEdit | AnthropicClearThinkingEdit;
...
export interface MessageStartEvent extends BaseStreamEvent {
    ...
    message: {
        ...
        stop_sequence: string | null;
        usage: Omit<AnthropicUsage, "service_tier">;
    };
}
export interface ContentBlockStartEvent extends BaseStreamEvent {
    type: "content_block_start";
    index: number;
    content_block: Pick<AnthropicContentBlock, "type" | "text" | "id" | "name" | "input" | "thinking" | "citations">;
}
...
export type AnthropicStreamEvent = MessageStartEvent | ContentBlockStartEvent | ContentBlockDeltaEvent | ContentBlockStopEvent | MessageDeltaEvent | MessageStopEvent | PingEvent | ErrorEvent;
export type { AnthropicStopReason, AnthropicUsage, AnthropicContentBlock, AnthropicTool, AnthropicWebSearchTool, AnthropicToolChoice, } from "./common";
