...
exports.googleProvider = exports.modelDetails = exports.costs = void 0;
exports.costs = [
    {
        model: {
            operator: "includes",
...
exports.modelDetails = {
    ...
    "gemini-2.5-pro": {
        ...
        info: {
            ...
            description: "Google's most advanced 'thinking model' with enhanced reasoning capabilities. Currently in experimental phase, it leads on complex reasoning, code generation, and multimodal tasks.",
            tradeOffs: [
    ...
    "gemini-2.5-flash-lite": {
        ...
        info: {
            ...
            description: "Google's most cost-effective model in the 2.5 series, designed for high-volume applications requiring excellent performance at the lowest cost. Features enhanced speed and efficiency while maintaining strong capabilities.",
            tradeOffs: [
...
exports.googleProvider = {
    costs: exports.costs,
    modelDetails: exports.modelDetails,
};
