...
exports.anthropicProvider = exports.modelDetails = exports.costs = void 0;
exports.costs = [
    {
        model: {
            operator: "equals",
...
for (const parentModel in exports.modelDetails) {
    const details = exports.modelDetails[parentModel];
