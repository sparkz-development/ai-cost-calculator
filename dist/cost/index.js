...
function costOfPrompt({ provider, model, promptTokens, promptCacheWriteTokens, promptCacheReadTokens, promptAudioTokens, completionTokens, completionAudioTokens, images = 1, perCall = 1, }) {
    var _a, _b;
  ...
  ${costs
        ...
        const costPerMultiple = {
            ...
            prompt_cache_write: Math.round(((_c = cost.cost.prompt_cache_write_token) !== null && _c !== void 0 ? _c : cost.cost.prompt_token) *
                multiple),
            prompt_cache_read: Math.round(((_d = cost.cost.prompt_cache_read_token) !== null && _d !== void 0 ? _d : cost.cost.prompt_token) *
                multiple),
