...
exports.endpoints = {
    ...
    "gpt-5.4:openrouter": {
        ...
        pricing: [
            {
                threshold: 0,
                input: 0.0000026375, // $2.6375/1M - worst-case: $2.50/1M (OpenAI) * 1.055
                output: 0.000015825, // $15.825/1M - worst-case: $15.00/1M (OpenAI) * 1.055
                web_search: 0.01, // $10 per 1000 searches (1:1 USD; 10/1K)
            },
            {
                threshold: 272000,
                input: 0.000005275, // $5.275/1M - worst-case: $5.00/1M (OpenAI) * 1.055
                output: 0.0000237375, // $23.7375/1M - worst-case: $22.50/1M (OpenAI) * 1.055
            },
        ],
        contextLength: 1050000,
        maxCompletionTokens: 128000,
