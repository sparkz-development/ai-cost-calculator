...
exports.HeliconeTemplateManager = exports.BOOLEAN_VALUES = exports.PROMPT_PARTIAL_REGEX = exports.TEMPLATE_REGEX = void 0;
exports.TEMPLATE_REGEX = /\{\{\s*hc\s*:\s*([a-zA-Z_-][a-zA-Z0-9_-]*)\s*:\s*([a-zA-Z_-][a-zA-Z0-9_-]*)\s*\}\}/g;
exports.PROMPT_PARTIAL_REGEX = /\{\{\s*hcp\s*:\s*([a-zA-Z0-9]{6})\s*:\s*(\d+)\s*(?::\s*([a-zA-Z_-][a-zA-Z0-9_-]*))?\s*\}\}/g;
exports.BOOLEAN_VALUES = ['true', 'false', 'yes', 'no'];
class HeliconeTemplateManager {
     ...
     */
    static extractPromptPartialVariables(template) {
        const variables = new Map();
        let match;
        exports.PROMPT_PARTIAL_REGEX.lastIndex = 0;
        while ((match = exports.PROMPT_PARTIAL_REGEX.exec(template)) !== null) {
    ...
    static extractVariables(template) {
        const variables = new Map();
        let match;
        exports.TEMPLATE_REGEX.lastIndex = 0;
        while ((match = exports.TEMPLATE_REGEX.exec(template)) !== null) {
        ...
        switch (expectedType) {
            ...
            case 'boolean':
                return typeof value === 'boolean' ||
                    (typeof value === 'string' && exports.BOOLEAN_VALUES.includes(value.toLowerCase()));
            default:
                return true;
        }
    }
     ...
     */
    static substituteVariables(template, inputs, promptPartialInputs) {
        ...
        exports.PROMPT_PARTIAL_REGEX.lastIndex = 0;
        let result = template.replace(exports.PROMPT_PARTIAL_REGEX, (match) => {
        ...
        exports.TEMPLATE_REGEX.lastIndex = 0;
        result = result.replace(exports.TEMPLATE_REGEX, (match, name) => {
    ...
    static performRegexReplacement(str, inputs) {
        exports.TEMPLATE_REGEX.lastIndex = 0;
        return str.replace(exports.TEMPLATE_REGEX, (match, name) => {
...
exports.HeliconeTemplateManager = HeliconeTemplateManager;
HeliconeTemplateManager.isWholeMatch = (str) => {
    if (typeof str !== 'string')
        return false;
    exports.TEMPLATE_REGEX.lastIndex = 0;
    const match = exports.TEMPLATE_REGEX.exec(str);
